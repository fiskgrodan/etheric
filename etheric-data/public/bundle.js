var app = (function () {
	...
	function create_fragment(ctx) {
		...
		return {
			c: function create() {
				...
				t4 = text("Is mobile: ");
				t5 = text(ctx.$media);
				h10.className = "svelte-8v25zq";
				add_location(h10, file, 17, 0, 240);
				h11.className = "svelte-8v25zq";
				add_location(h11, file, 18, 0, 265);
			},
			...
			p: function update(changed, ctx) {
				if (changed.$hash) {
					set_data(t1, ctx.$hash);
				}

				if (changed.$media) {
					set_data(t5, ctx.$media);
				}
			},
	...
	function instance($$self, $$props, $$invalidate) {
		...
		subscribe($$self, media, $$value => { $media = $$value; $$invalidate('$media', $media); });
